...
| カテゴリ | 具体的な項目 | 
| --- | --- | 
| 法人基本情報 | 法人名・代表者名・資本金・従業員数・設立年 |
| 補助金情報 | AMED・経産省・厚労省の補助金・採択課題名・金額 |
| 調達情報 | 官公庁との契約実績・落札金額 | 
| 届出・認定 | 再生医療等提供計画の認定・薬事関連届出 | 
| 表彰情報 | 経産省・厚労省からの表彰歴 | 

特に **補助金情報** が強力だ。非上場企業も、AMED補助金の採択情報は公開されているため、財務情報がゼロの企業でも資金の流れが見える。
...
## おわりに
今回は、gBizinfoの簡単な使いかたを紹介しました。今後は、その他のオープンデータを利用した解析について書いていきたいと思います。
